def calculate_resume_score(skills, details, text):
    ...
    education_keywords = ["b.tech", "b.e", "bachelor", "m.tech", "m.e", "master", "bca", "mca", "b.sc", "m.sc", "degree"]
    ...
    experience_keywords = ["experience", "work experience", "professional experience", "employment", "employment history", "work history", "internship", "intern", "engineer", "developer", "analyst", "manager"]
